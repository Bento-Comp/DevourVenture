...
namespace UniBallistic
{
	public class fts {
		...
		// gravity (float): force of gravity, positive down
		// useSmallestTime (bool) : if true -> return the solution corresponding to the smallest time before impact, else -> the other one
		//
		// return (Vector3): firing solution
		public static Vector3 solve_ballistic_arc(Vector3 proj_pos, float proj_speed, Vector3 target_pos, float gravity, bool useSmallestTime)
		{
			Vector3 s0;
			Vector3 s1;
			int solutionCount = solve_ballistic_arc(proj_pos, proj_speed, target_pos, gravity, out s0, out s1);
		...
		//
		// return (Vector3): firing solution
		public static Vector3 solve_ballistic_arc(Vector3 proj_pos, float proj_speed, Vector3 target_pos, Vector3 target_velocity, float gravity, bool useSmallestTime)
		{
			Vector3 s0;
			Vector3 s1;
			int solutionCount = solve_ballistic_arc(proj_pos, proj_speed, target_pos, target_velocity, gravity, out s0, out s1);
